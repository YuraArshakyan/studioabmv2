...
<div class="container">
    <section class="gallery">
        ...
        <div class="frame frame_bg">
            <div class="frame__content">
                <div class="frame-media frame-media_left" style="background-image: url(projects_content/2.jpg)"></div>
            </div>
        </div>
        ...
        <div class="frame frame_bg">
            <div class="frame__content">
                <div class="frame-media frame-media_right" style="background-image: url(projects_content/3.jpg)"></div>
            </div>
        </div>
        ...
        <div class="frame frame_bg">
            <div class="frame__content">
                <div class="frame-media frame-media_right" style="background-image: url(projects_content/1.jpg)"></div>
            </div>
        </div>
        <div class="frame"></div>
        <div class="frame"></div>
